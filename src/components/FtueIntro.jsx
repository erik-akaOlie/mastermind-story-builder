...
import { handArrowPath, handArrowPathWavy, arrowheadPath } from '../lib/handDrawn.js'
...
// ----------------------------------------------------------------------------
// Hand-drawn-styled SVG path helpers — extracted to lib/handDrawn.js when the
// picker's empty-library state became the second consumer (the "handwritten
// guidance" product pattern). Re-exported here so existing imports and the
// unit tests keep pinning this surface.
// ----------------------------------------------------------------------------
export { handArrowPath, handArrowPathWavy, arrowheadPath } from '../lib/handDrawn.js'
