...
import { canApplyInverse, canApplyForward, applyInverse, applyForward } from './moveCard.js'
...
describe('moveCard — canApplyInverse', () => {
...
describe('moveCard — canApplyForward', () => {
...
describe('moveCard — applyInverse', () => {
...
describe('moveCard — applyForward', () => {
