...
| 2026-05-27 | Christopher Fedak (DM) | As the number of cards grows, organizing them visually gets hard; wants to collapse a group of notes/cards into a single block. | Monitor | Discovery complete (2026-06-12 — [grouping-discovery.md](./grouping-discovery.md); "nesting as a card capability" is the leading hypothesis, pending a design/architecture spike) |
