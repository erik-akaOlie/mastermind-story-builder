...
|---|---|---|---|---|
| 2026-05-19 | Todd Agnello (game designer) | When a card was selected and the non-selected nodes faded into the background, the effect felt too strong — described as "everything goes black" and distracting. | Monitor | Watching |
...
| 2026-05-19 | Todd Agnello (game designer) | Did not add a thumbnail image to any card during the session. The affordance to do so was not visible. | Quick Win | In Progress (2026-05-22 — pencil edit icon in EditModal header; always visible when no thumbnail, hover-only when thumbnail present) |
